...
// 공장별 분석기 인스턴스 생성
const factoryAnalyzers = {
    'jinsungpc': new FactoryAnalyzer('진성피씨'),
    'narapc': new FactoryAnalyzer('나라피씨'),
    'isui_umseong': new FactoryAnalyzer('이수이앤씨 - 음성공장'),
    'isui_yeoju': new FactoryAnalyzer('이수이앤씨 - 여주공장'),
    'jisan': new FactoryAnalyzer('지산개발')
};

// 공장별 분석 함수
function analyzeFactoryFiles(factoryId) {
    return factoryAnalyzers[factoryId].analyzeFiles();
} 